...
# 2. Coincashew : Harden your server
...
{% embed url="https://www.simplified.guide/ubuntu/install-ssh-server" caption="" %}

In case you need a SSH client for your operating system, refer to:

{% embed url="https://www.howtogeek.com/311287/how-to-connect-to-an-ssh-server-from-windows-macos-or-linux/" caption="" %}
